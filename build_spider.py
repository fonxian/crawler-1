...
# 解析详情页
def parse_deail_all(html,company_id):
    soup = BeautifulSoup(html,"html.parser")
    ...
    for i in test:
        ...
        builds = (credit_code,company_name,company_person,area,business_code,reg_type,address)
